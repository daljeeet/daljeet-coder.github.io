    ...
    
    {
        data?.map((el,id)=><div key={id} className="w-full flex flex-col flex-wrap lg:flex-row justify-between items-center border-b-darkbg border-b-4 rounded-2xl mb-4 ">
            ...
            <div
              ...
              className="md:min-w-[26rem]  md:w-1/3 rounded-xl bg-gradf/40 lg:mb-20 p-2 sm:p-10 shadow-[20px_25px_40px] shadow-darkbg border-2 border-gray-700"
            >
              ...
              <div className="flex justify-between w-5/6 mt-8 m-auto flex-wrap">
                <a
                  href={el.github}
                  target="_blank"
                  className=" px-6 rounded-2xl bg-mac py-1 my-2 flex items-center border-[1px] border-[1px] border-fontcolor hover:shadow-[5px_5px_6px] hover:shadow-fontcolor border-gray-400"
                  rel="noreferrer"
                >
                ...
                <a
                  href={el.website}
                  target="_blank"
                  className=" px-6 rounded-2xl py-1 my-2 flex items-center border-[1px] border-fontcolor hover:shadow-[-2px_5px_6px] hover:shadow-fontcolor hover:animate- border-gray-400"
                  rel="noreferrer"
                >
