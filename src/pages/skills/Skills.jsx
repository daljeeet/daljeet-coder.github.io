...
const Skills = () => {
 ...
 setTech(false)
  ...
  return (
    <div id='skills' className='w-5/6 m-auto text-center my-20 py-10' >
        ...
        <div className='flex' >
          ...
          <div className={`w-full h-80 `} >
            ...
            <TechSkills skill={'HTML'} percentage="90%" width='11/12'/>
            <TechSkills skill={'CSS'} percentage="90%" width='11/12' />
            <TechSkills skill={'JavaScript'} percentage="80%" width='5/6' />
            <TechSkills skill={'React'} percentage="90%" width='11/12' />
            <TechSkills skill={'TypeScript'} percentage="75%" width='3/4'/>
            <TechSkills skill={'Redux'} percentage="90%" width='11/12'/>
            </div>
            <div className={`${!tech?"":"hidden"}`} >
            <ul className='' >
