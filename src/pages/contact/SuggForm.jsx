...
const SuggForm = () => {
  ...
  return (
    ...
    <form target="_blank" action="https://formsubmit.co/2a7dbf0560568d3826d835b3c6d41f4b" method="POST" onSubmit={handleSubmit} >
            <input type="name" className='bg-darkbg border-2 h-10 w-5/6 rounded-md border-lightbg outline-0 color-textcolor px-4' placeholder='Your Name' name='name' required />
            <input type="email" className='bg-darkbg border-2 outline-0 h-10 w-5/6 rounded-md my-4 border-lightbg color-white px-4' placeholder='Your Email' name='email' required />
            <textarea name="suggession" cols="60" rows="6" className='bg-darkbg rounded-md w-5/6 border-lightbg border-2 border-lightbg p-4 outline-none max-h-32 ' placeholder='Write here...' required ></textarea> <br />
