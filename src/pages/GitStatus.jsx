...
const GitStatus = () => {
  return (
    ...
    data-aos-easing="ease-in-out" className="m-auto border-2 border-gray-600 bg-gradf/40 rounded-xl" >
          <img
            ...
            <div data-aos="zoom-in-up" data-aos-offset="200" data-aos-delay="50"
    data-aos-duration="1000"
    data-aos-easing="ease-in-out" className="m-auto border-2 border-gray-600 bg-gradf/40 rounded-xl my-10" >
    ...
    data-aos-duration="1000"
    data-aos-easing="ease-in-out" className="m-auto py-6 md:w-1/2 border-2 border-gray-600 bg-gradf/40 rounded-xl mb-10" >
        <img
          className="m-auto"
     ...
     data-aos-duration="2000" className="m-auto bg-gradf/40 border-2 text-center border-gray-600 rounded-xl my-10" >
