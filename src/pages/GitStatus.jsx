    ...
    <div className="w-11/12 m-auto" >
      <div className="mx-auto md:block flex flex-col">
        ...
        <div className="flex flex-col md:flex-row">
          <div className="m-auto border-2 border-black/50 bg-gradf/40 rounded-xl" >
          <img
            ...
            <div className="m-auto border-2 border-black/50 bg-gradf/40 rounded-xl my-10" >
        ...
        <div className="m-auto md:w-11/12 border-2 border-black/50 bg-gradf/40 rounded-xl mb-10" >
        <img
          className="m-auto"
          ...
          <div className="m-auto border-black/50 bg-gradf/40 text-center border-black/40 rounded-xl my-10" >
